...
</script><script>import { Editor, Node } from 'slate';
import { direction } from '../direction';
import Children from './Children.svelte';
import Text from './Text.svelte';
import { findKey, getFromContext } from '../utils';
import { EDITOR_TO_KEY_TO_ELEMENT, ELEMENT_TO_NODE, NODE_TO_ELEMENT, NODE_TO_INDEX, NODE_TO_PARENT } from '../weakMaps';
...
</script><svelte:component this={Element} bind:ref {isVoid} {isInline} {contenteditable} {element} {dir}
